...
import cdlinter.datamining.gitlab.entities.Branch;
...
import cdlinter.datamining.gitlab.entities.Job;
import cdlinter.datamining.gitlab.entities.Language;
import cdlinter.datamining.gitlab.entities.MergeRequest;
import cdlinter.datamining.gitlab.entities.Pipeline;
import cdlinter.datamining.gitlab.entities.Project;
import cdlinter.datamining.gitlab.entities.ProjectItem;
import cdlinter.datamining.gitlab.entities.Tag;
import cdlinter.utils.HTTPConnector;
import cdlinter.utils.TCIDateFormatter;
...
public class GitLabMiner {
	...
	public static void main2(String[] args) throws ParseException, IOException {
		...
		List<Project> projects = gm.getProjects();
...
*/
		...
		String input = "/Users/xxx/Documents/CI-Linter/cd-linter-paper/resources/gitlab-issue-monitoring/"+ name +".csv";
		FileReader reader = new FileReader(input);
		String output = "/Users/xxx/Documents/CI-Linter/cd-linter-paper/resources/gitlab-issue-monitoring/"+ name +"_upd.csv";
